...
from pong.views import game, pong, navbar, settings, profile, tournamentLocal, tournamentOnline
...
urlpatterns = [
    ...
    path('tournament/online/', tournamentOnline, name='tournamentOnline'),
